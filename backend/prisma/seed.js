// seed.js - UPDATED FOR SINGLE BERAKHLAK CATEGORY
...
async function main() {
  console.log('🌱 Starting database seeding for Single BerAKHLAK Category...');
  ...
  try {
    ...
    // =====================
    // 3. 🔥 UPDATED: SEED RENTANG NILAI - SINGLE CATEGORY
    // =====================
    console.log('📈 Seeding Rentang Nilai (Single Category)...');
    ...
    // =====================
    // 5. 🔥 UPDATED: SEED SYSTEM SETTINGS
    // =====================
    ...
    const systemSettings = [
      ...
      {
        key: 'berakhlak_calculation',
        value: 'DIRECT_SUM',
        description: 'Metode kalkulasi: DIRECT_SUM (tidak di-average)'
      },
      {
      ...
      },
      {
        ...
        value: 'TIERED_FREQUENCY',
        description: 'Metode kalkulasi presensi: berdasarkan frekuensi bertingkat'
      }
    ];
    ...
    for (const pegawai of pegawaiBPS) {
      await prisma.user.upsert({
        ...
        create: {
          ...
          mobilePhone: pegawai.mobilePhone,
    ...
    console.log('');
    console.log('🎯 Single BerAKHLAK Category Features:');
    console.log('   • Score Range: 80-100 (single category)');
    console.log('   • Calculation Method: Direct Sum (no averaging)');
    console.log('   • User selects 1 employee (not 3)');
    console.log('   • Higher final scores possible (can exceed 100)');
